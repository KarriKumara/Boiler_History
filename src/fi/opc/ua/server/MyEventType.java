...
public class MyEventType extends BaseEventTypeNode {
	...
	public static final UnsignedInteger MY_PROPERTY_ID = UnsignedInteger
			.valueOf(10001);
	public static final String MY_PROPERTY_NAME = "MyProperty";
	public static final UnsignedInteger MY_VARIABLE_ID = UnsignedInteger
			.valueOf(10002);
	 ...
	 * visibility.
	 */
	protected MyEventType(NodeManagerUaNode nodeManager, NodeId nodeId,
	...
	public UaProperty getMyPropertyNode() {
		UaProperty property = getProperty(new QualifiedName(getNodeManager()
				.getNamespaceIndex(), MY_PROPERTY_NAME));
		return property;
	}
	...
	public UaVariable getMyVariableNode() {
		UaVariable property = (UaVariable) getComponent(new QualifiedName(
				getNodeManager().getNamespaceIndex(), MY_VARIABLE_NAME));
		return property;
	}
